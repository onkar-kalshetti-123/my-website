...
$year=$_POST['year'];
$dept=$_POST['dept'];
$sql = "INSERT INTO voter VALUES('$id','$pass','$fname','$lname','$year','$dept')";
...
<head>
	...
	<title>Online Voting System |Admin Add Voter </title>
...
<div class="col-sm-4">
<input type="text" name="v-id" class="form-control" required>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Give Password :<span style="color:red">*</span></label>
<div class="col-sm-4">
